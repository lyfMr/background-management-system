...
//            System.out.println("http://" + req.getServerName() + ":" + req.getServerPort() + req.getContextPath() + uri);
//            System.out.println(getServletContext().getRealPath(uri));
//            OutputStream out=resp.getOutputStream();
//            InputStream in = new FileInputStream(getServletContext().getRealPath(uri));
//
//            int len = 0;
