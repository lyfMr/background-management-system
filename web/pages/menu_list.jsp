                                ...
                                <c:if test="${not empty menu.list}">
                                    <ul class="nav nav-subnav">
                                        <c:forEach var="menuItem" items="${menu.list}">
                                            <li
                                                <c:if test="${menuItem.id==5}"> class="active" </c:if> >
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="href" class="control-label">父级菜单：</label>
                                                            <input type="text" class="form-control" id="pId">
                                                        </div>
<%--                                                        <div class="form-group">--%>
<%--                                                            <label for="href" class="control-label">创建时间：</label>--%>
...
<script type="text/javascript">
    ...
    function emptyInput() {
        ...
        document.getElementById("href").value = null;
