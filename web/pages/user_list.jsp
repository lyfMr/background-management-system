                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                ...
                                <div class="toolbar-btn-action">
                                    ...
                                    <a data-toggle="modal" data-target="#editMenu" class="btn btn-primary m-r-5" href="#!" onclick="addUser()"><i class="mdi mdi-plus"></i> 新增</a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="userForm">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="sPassword" class="control-label">再次输入密码：</label>
                                                            <input type="password" class="form-control" id="sPassword">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="nikeName" class="control-label">昵称：</label>
                                                        ...
                                                        <div class="radio">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="sexOptions" id="sex1" value="1"> 男
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="sexOptions" id="sex2" value="0"> 女
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
...
<script type="text/javascript">
    ...
    function addUser() {
        ...
        document.getElementById("exampleModalLabel").innerText="添加用户";
    }
    ...
    function saveUser() {
        if (true){
            ...
            let sex = document.getElementsByName("sexOptions");
    ...
    function getUserById(id) {
        type=0;
        document.getElementById("exampleModalLabel").innerText="修改用户"
        console.log(type);
        if (id == null) {
            alert("获取id异常")
            return;
        ...
        $.ajax({
            ...
            success(res) {
                if (res.code == 200) {
                    ...
                    document.getElementById("nikeName").value = res.data.nickName;
                    document.getElementById("tel").value = res.data.tel;
                    document.getElementById("address").value = res.data.address;
                    document.getElementById("createTime").value = res.data.createTime;
                    console.log(typeof res.data.sex);
